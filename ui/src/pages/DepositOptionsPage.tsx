  ...
  CASH_USD: [
    {
      ...
      placeholder: "Ej: Coordinar con el equipo",
    },
  ],
  LEMON: [
  ...
  CRYPTO: [
    {
      key: "address",
      label: "Dirección *",
      placeholder: "Ej: TF7j33woKnMVFALtvRVdnFWnneNrUCVvAr",
    },
    {
      key: "network",
      label: "Red *",
      placeholder: "Ej: TRC20, BEP20, ERC20, Polygon",
    },
  ],
  SWIFT: [
    ...
    },
    {
      ...
      placeholder: "Ej: 084009519",
    },
    {
      key: "bank_address",
      label: "Dirección del banco (opcional)",
      placeholder: "Ej: 33 Whitehall St, New York",
    },
  ],
};
      ...
      {showForm && (
        <DepositOptionForm
          ...
          onCategoryChange={(cat) =>
            handleCategoryChange(cat, setFormData, formData)
          }
        />
      )}
              ...
              >
                {editingId === opt.id ? (
                  <DepositOptionForm
                    ...
                    submitLabel="Guardar"
                    onCategoryChange={(cat) =>
                      handleCategoryChange(cat, setEditForm, editForm)
                    }
                    allowActiveEdit
                  />
                ) : (
                  <OptionCard
                    ...
                    onDelete={() =>
                      setDeleteConfirm({ isOpen: true, option: opt })
                    }
                  />
                )}
              </div>
                ...
                <div key={f.key}>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        details: { ...form.details, [f.key]: e.target.value },
                      })
                    }
