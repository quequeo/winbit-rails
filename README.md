...
RAILS_MASTER_KEY=...
RESEND_API_KEY=...
RESEND_FROM_EMAIL=...   # prod: Winbit <noreply@winbit.com.ar> (dominio verificado en Resend; no usar @gmail.com como From)
RESEND_REPLY_TO=...     # default: winbit.cfds@gmail.com
